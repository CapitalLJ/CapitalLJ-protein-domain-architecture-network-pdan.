# -*- encoding: utf-8 -*-
'''
@File    :   distance_cos_boot.py
@Time    :   2024/07/01 16:21:39
@Author  :   Leilingjie 
@Version :   1.0
...
def normol_get():
    parser = argparse.ArgumentParser(description="python distance_cosine_boot.py -i input_file -o output_folder -b num_bootstrap")
...
def distance_cosine(input_file, output_folder, num_bootstrap):
    ...
    for i in range(num_bootstrap):
        ...
        # 计算余弦距离
        cosine_distances = pdist(sampled_vectors.T, metric='cosine')
        
        similarity_matrix = squareform(cosine_distances)
...
if __name__ == '__main__':
    ...
    distance_cosine(input_file, output_folder, num_bootstrap)